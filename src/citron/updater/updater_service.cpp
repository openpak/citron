...
#if defined(_WIN32)
    "https://api.github.com/repos/OpenPakNetwork/citron-nextendo/releases/tags/nightly-windows";
#elif defined(__linux__)
    "https://api.github.com/repos/OpenPakNetwork/citron-nextendo/releases/tags/nightly-linux";
#else
    "https://api.github.com/repos/OpenPakNetwork/citron-nextendo/releases";
#endif
